...
class Admin extends \Api_Abstract
{
    ...
    public function change_plan($data)
    {
        ...
        $plan = $this->di['db']->getExistingModelById('ServicesaasHp', $data['plan_id'], 'Hosting plan not found');
    ...
    {
        $servers = $this->di['db']->find('ServicesaasServer', 'ORDER BY id ASC');
        $serversArr = [];
    ...
    public function server_get($data)
    {
        ...
        $model = $this->di['db']->getExistingModelById('ServicesaasServer', $data['id'], 'Server not found');
        $service = $this->getService();
    ...
    public function hp_get_list($data)
    {
        ...
        foreach ($pager['list'] as $key => $item) {
            $model = $this->di['db']->getExistingModelById('ServicesaasHp', $item['id'], 'Post not found');
    ...
    public function hp_delete($data)
    {
        ...
        $model = $this->di['db']->getExistingModelById('ServicesaasHp', $data['id'], 'Hosting plan not found');
