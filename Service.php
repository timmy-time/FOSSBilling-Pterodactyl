...
class Service implements InjectionAwareInterface
{
    ...
    public function action_create(\Model_ClientOrder $order)
    {
        ...
        $server = $this->di['db']->getExistingModelById('ServicesaasServer', $c['server_id'], 'Server from order configuration was not found');

        $hp = $this->di['db']->getExistingModelById('ServicesaasHp', $c['hosting_plan_id'], 'Hosting plan from order configuration was not found');

        $model = $this->di['db']->dispense('Servicesaas');
    ...
    public function action_delete(\Model_ClientOrder $order)
    {
        ...
        if ($service instanceof \Model_Servicesaas) {
    ...
    public function changeAccountPlan(\Model_ClientOrder $order, \Model_Servicesaas $model, \Model_ServicesaasHp $hp)
    {
        $model->service_hosting_hp_id = $hp->id;
    ...
    public function changeAccountUsername(\Model_ClientOrder $order, \Model_Servicesaas $model, $data)
    {
    ...
    public function changeAccountIp(\Model_ClientOrder $order, \Model_Servicesaas $model, $data)
    {
    ...
    public function changeAccountDomain(\Model_ClientOrder $order, \Model_Servicesaas $model, $data)
    {
        if (!isset($data['tld']) || empty($data['tld']) ||
    ...
    public function changeAccountPassword(\Model_ClientOrder $order, \Model_Servicesaas $model, $data)
    {
    ...
    public function sync(\Model_ClientOrder $order, \Model_Servicesaas $model)
    {
        [$adapter, $account] = $this->_getAM($model);
    ...
    private function _getDomainOrderId(\Model_Servicesaas $model)
    {
        $orderService = $this->di['mod_service']('order');
    ...
    public function _getAM(\Model_Servicesaas $model, \Model_ServicesaasHp $hp = null)
    {
        if (null === $hp) {
            $hp = $this->di['db']->getExistingModelById('ServicesaasHp', $model->service_hosting_hp_id, 'Hosting plan not found');
        }

        $server = $this->di['db']->getExistingModelById('ServicesaasServer', $model->service_hosting_server_id, 'Server not found');
    ...
    public function toApiArray(\Model_Servicesaas $model, $deep = false, $identity = null)
    {
        $ServicesaasServerModel = $this->di['db']->load('ServicesaasServer', $model->service_hosting_server_id);
        $ServicesaasHpModel = $this->di['db']->load('ServicesaasHp', $model->service_hosting_hp_id);
        $server = $this->toHostingServerApiArray($ServicesaasServerModel, $deep, $identity);
        $hp = $this->toHostingHpApiArray($ServicesaasHpModel, $deep, $identity);
    ...
    public function toHostingServerApiArray(\Model_ServicesaasServer $model, $deep = false, $identity = null)
    {
    ...
    public function update(\Model_Servicesaas $model, array $data)
    {
        if (isset($data['username']) && !empty($data['username'])) {
    ...
    {
        $model = $this->di['db']->dispense('ServicesaasServer');
        $model->name = $name;
        $model->ip = $ip;
    ...
    public function deleteServer(\Model_ServicesaasServer $model)
    {
        $id = $model->id;
    ...
    public function updateServer(\Model_ServicesaasServer $model, array $data)
    {
    ...
    public function getServerManager(\Model_ServicesaasServer $model)
    {
    ...
    public function testConnection(\Model_ServicesaasServer $model)
    {
    ...
    public function deleteHp(\Model_ServicesaasHp $model)
    {
        $id = $model->id;
        $Servicesaas = $this->di['db']->findOne('Servicesaas', 'service_hosting_hp_id = ?', [$model->id]);
        if ($Servicesaas) {
    ...
    public function toHostingHpApiArray(\Model_ServicesaasHp $model, $deep = false, $identity = null)
    {
        $result = [
            'id' => $model->id,
    ...
    public function updateHp(\Model_ServicesaasHp $model, array $data)
    {
        $model->name = $this->di['array_get']($data, 'name', $model->name);
    ...
    {
        $model = $this->di['db']->dispense('ServicesaasHp');
        $model->name = $name;
    ...
    public function getServerPackage(\Model_ServicesaasHp $model)
    {
        $config = json_decode($model->config, 1);
        if (!is_array($config)) {
            $config = [];
    ...
    public function getServerManagerWithLog(\Model_ServicesaasServer $model, \Model_ClientOrder $order)
    {
    ...
    public function getMangerUrls(\Model_ServicesaasServer $model)
    {
        try {
            $m = $this->getServerManager($model);
